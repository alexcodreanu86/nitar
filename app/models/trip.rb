class Trip < ActiveRecord::Base
  ...
  validates :trip_type, :car_id, :number_of_passengers, :pickup_time, :pick_up, :drop_off, :contact_first_name, :contact_last_name, :contact_phone, :contact_email, :confirmed_agreement, presence: true
